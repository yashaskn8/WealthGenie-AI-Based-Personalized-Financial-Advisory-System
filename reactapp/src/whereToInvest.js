...
const WHERE_TO_INVEST = {
  ...
  debt_mf: {
    ...
    products: [
      ...
      { name: "ICICI Pru Short Term Fund", provider: "ICICI Prudential AMC", rate: "~7.1% (5Y CAGR)", highlight: "AUM ~₹20,000 Cr — one of the largest short-term debt funds. Expense ratio: 0.35% (Direct). Strong risk management with credit profile consistently >95% in AAA/sovereign papers. ICICI Prudential's fixed-income team is among the most experienced in India with 20+ years of track record.", platform: "ICICI Direct / Groww", minInvestment: "₹100 SIP" },
